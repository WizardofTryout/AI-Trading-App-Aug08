...
import { getSettings, saveSettings, Settings } from '../services/api';
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <select id="tradeDirection" className="w-full bg-accent p-2 rounded" value={settings.tradeDirection} onChange={handleChange}>
                <option>Long</option>
                <option>Short</option>
                <option>Both</option>
              </select>
